...
class RaidStream(RaidListener):
    def __init__(self):
        self.consumer_key = 'H2XBXyn7WUFXFkCNaCIXLL8fX'
        self.consumer_secret = 'g12Lh1gGG9O6t4fRggoZd9UdKScqvf1rVznVHSjyXuUhRcOgkV'        
        self.access_token = '728426363388993536-Ge7rFUzQAW8QW2a92FJkqgDlf4b8bav'
        self.access_token_secret = 'moxRSpxDXSvUQQD5EDBTRaF9W5V1cgkrK5TDvGHrV5dhQ'
    ...
    def twitter_results(self, api, RaidListener, search):
        ...
        stream.filter(track=[search], languages = ['en', 'ja'], async=True)
...
def main():
    ...
    while True:
        ...
        if answer == "1":
            print('Starting...')
            stream.twitter_results(stream.twitter_login(), gbf, search)
